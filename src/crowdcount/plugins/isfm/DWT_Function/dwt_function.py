...
class DWT_Function(Function):
    ...
    def forward(ctx, x, w_ll, w_lh, w_hl, w_hh):
        ...
        w_ll = w_ll.to(dtype=target_dtype)
        w_lh = w_lh.to(dtype=target_dtype)
        w_hl = w_hl.to(dtype=target_dtype)
        w_hh = w_hh.to(dtype=target_dtype)
...
class IDWT_Function(Function):
    ...
    def forward(ctx, x, filters):
        target_dtype = x.dtype
        filters = filters.to(dtype=target_dtype)
